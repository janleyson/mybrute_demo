...
namespace Framework.MVC
{
    ...
    public class BaseApplication : Element
    {
        ...
        /// </summary>
        public Model Model { get { return m_model = FindAssert<Model>(m_model); } }
        private Model m_model;

        /// <summary>
        /// Fetches the root View instance.
        /// </summary>
        public View View { get { return m_view = FindAssert<View>(m_view); } }
        private View m_view;

        /// <summary>
        /// Fetches the root Controller instance.
        /// </summary>
        public Controller Controller { get { return m_controller = FindAssert<Controller>(m_controller); } }
        ...
        virtual protected void Start()
        {
			...
			if (m_first_scene) { 
				m_first_scene = false;  
				SceneManager.sceneLoaded += OnLevelLoaded(SceneManager.GetActiveScene().buildIndex);
			}
        }
		...
		private UnityAction<Scene, LoadSceneMode> OnLevelLoaded(int p_level)
        {
			Notify("scene.load", new object[] { SceneManager.GetActiveScene().name, SceneManager.GetActiveScene().buildIndex });
			return null;
        }
        ...
        private IEnumerator SceneLoadAsync(string p_name,bool p_additive,params string[] p_args)
        {
            ...
            else
            {
				...
				async = SceneManager.LoadSceneAsync(p_name);
            }
